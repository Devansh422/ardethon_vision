...
const NavBarLayout = () => {
  ...
  return (
    <nav className="h-14 w-full bg-level1 relative flex py-2.5 pl-5 pr-4 text-black items-center z-20 print:hidden">
      <Link href="/">
      ...
      <div className="flex-auto flex justify-between items-center ml-5">
        ...
        <NavBarActions>
          <StyledButton className='text-black px-4 py-1 rounded-full bg-color3 hover:bg-level4 hover:text-bgbase' variant="text" onClick={exportResumeData}>
            Export
          </StyledButton>
          <StyledButton
            variant="text"
            className='text-black px-4 py-1 rounded-full bg-color4 hover:bg-level4 hover:text-bgbase'
            onClick={() => {
